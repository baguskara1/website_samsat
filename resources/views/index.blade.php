...
<body>
    ...
    <div style="background: #ff5c5c; border-top: 2px solid #1e1e1e; border-bottom: 2px solid #1e1e1e; display: flex; align-items: center; color: #1e1e1e; font-weight: 600; font-size: 16px;">
        <div style="background: #1e1e1e; color: #fbfbfb; padding: 10px 20px; font-weight: bold; font-size: 14px; text-transform: uppercase; letter-spacing: 1px; border-right: 2px solid #1e1e1e; white-space: nowrap;">
            INFO JADWAL
        </div>
