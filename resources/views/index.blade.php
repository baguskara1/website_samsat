        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .about-box-premium {
                ...
                transition: transform 0.3s ease, box-shadow 0.3s ease;
                max-width: 900px;
                margin: 0 auto; /* Biar kotaknya posisinya di tengah */
            }
...
<body>
    ...
    <section id="about" class="container" style="padding: 80px 100px;">
        <div class="about-box-premium">       
            ...
            <p style="font-size: 18px; color: #4a4a4a; margin-bottom: 40px; line-height: 1.6; max-width: 700px; margin-left: auto; margin-right: auto;">
